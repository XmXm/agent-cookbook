---
name: brainstorming
description: "Explore user intent, requirements and design before implementation. Asks clarifying questions, proposes approaches, and gets design approval before proceeding to planning."
---
...
2. **Assess scope** — if multiple independent subsystems, decompose into sub-projects
3. **Ask clarifying questions** — one at a time, understand purpose/constraints/success criteria
4. **Propose 2-3 approaches** — with trade-offs and your recommendation
5. **Present design** — in sections scaled to their complexity, get user approval after each section
6. **Save design doc** — record the validated design in project docs
7. **Prepare for planning** — transition to implementation planning
