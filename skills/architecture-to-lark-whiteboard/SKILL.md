---
name: architecture-to-lark-whiteboard
description: |
  ...
  Use when the user says 画架构图到飞书/飞书画板架构图/把架构图放进画板/Lark whiteboard architecture/feishu architecture whiteboard,
...
# architecture-to-lark-whiteboard
...
| architecture-diagram（HTML+SVG） | architecture-to-lark-whiteboard（画板 SVG） |
|---|---|
